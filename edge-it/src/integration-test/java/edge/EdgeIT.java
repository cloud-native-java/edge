...
public class EdgeIT {
    ...
    private File root, authServiceManifest, eurekaManifest, edgeServiceManifest, greetingsServiceManifest, html5ClientManifest;

    // never deletes the apps if theyre already there
    ...
    private void baselineDeploy(
        ...
        this.deployAppWithSettings(this.greetingsServiceManifest, gsProfiles, gsEnv, gsCallback);
        this.deployAppWithSettings(this.edgeServiceManifest, esProfiles, esEnv, esCallback);
