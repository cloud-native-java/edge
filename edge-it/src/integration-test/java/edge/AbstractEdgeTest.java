...
public abstract class AbstractEdgeTest {
 ...
 protected void deployAuthService() throws Throwable {
  ...
  if (!this.service.applicationExists(authService)) {
   this.service.pushApplicationUsingManifest(this.authServiceManifest);
 ...
 protected void defaultSetup(boolean delete) throws Throwable {
  ...
  if (delete) {
   ...
   this.service.destroyServiceIfExists(authServiceAppId);
  }
 }
 ...
 protected void baselineDeploy(String[] gsProfiles, Map<String, String> gsEnv,
  String[] esProfiles, Map<String, String> esEnv) throws Throwable {
