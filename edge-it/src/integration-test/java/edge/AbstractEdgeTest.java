...
public abstract class AbstractEdgeTest {
    ...
    protected void baselineDeploy(String[] gsProfiles, Map<String, String> gsEnv,
                                  ...
                                  ApplicationInstanceConfiguration esCallback) throws Throwable {
        ...
        if (null != gsCallback) gsCallback.configure(greetingsServiceId);
        ...
        if (null != esCallback) esCallback.configure(edgeServiceId);
